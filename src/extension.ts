...
export function activate(context: vscode.ExtensionContext) {
	...
	commands.push(
		vscode.commands.registerCommand('goalModel.changeRefinementType', async (element) => {
			try{
	...
	commands.push(
		vscode.commands.registerCommand('goalModel.setRuntimeAnnotation', async (element) => {
			try{
